...
## Manure evaluation and silage quality

See [Presentation Mary Beth Hall, Balchem](https://balchem.com/wp-content/uploads/2026/01/Manure_Evaluation_Figuring_Out_Whats_Going_on_Between_Cows__Their_Rations.pdf)

Page 15: Dairrhea, sign of ruminal acidosis, but can also be caused by spoiled feed!!
...
tabl1 |>
  gt(id="eight",rowname_col = "Item") |> 
    tab_header("Characteristics of the sheet.")
...
tabl3 |> gt(id = "nine",rowname_col = 'item') |> 
  tab_header("Characteristics of the silage.")
...
tabl4 |> gt(id = "ten",rowname_col = 'item') |> 
  tab_header("Feed quality in the silage.") 
```
